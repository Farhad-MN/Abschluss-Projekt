class Mountainbike(user: MutableMap<String, String>):Kategorie(user) {
    ...
    fun tourWaehlenMountainbike() {

        println("Tour für Mountainbike")
        ...
        if (eingabe == standOrtWaehlen[0]) {
            ...
            var schwiergkeit = ("Schwierigkeit: ${schwiergkeit[0]} ")
        ...
        if (eingabe == standOrtWaehlen[1]) {
            ...
            var schwiergkeit = ("Schwierigkeit: ${schwiergkeit[1]} ")
            println("Ihr gewählte Tour:")
            println("$tour, $dauer, $schwiergkeit")
        }
        ...
        if (eingabe == standOrtWaehlen[2]) {
            ...
            var schwiergkeit = ("Schwierigkeit: ${schwiergkeit[2]} ")
            println("Ihr gewählte Tour:")
            println("$tour, $dauer, $schwiergkeit")
        }
    }
